<?php
/**
 * File for class CodigosWebMotorsMotosStructTipoFreio
 ...
 */
/**
 * This class stands for CodigosWebMotorsMotosStructTipoFreio originally named TipoFreio
 ...
 * @date 2017-11-03
 */
class CodigosWebMotorsMotosStructTipoFreio extends CodigosWebMotorsMotosWsdlClass
{
    /**
     * The CodigoTipoFreio
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for TipoFreio
     ...
     */
    public function __construct($_codigoTipoFreio,$_descricao = NULL,$_codigoRetorno = NULL)
    {
        parent::__construct(array('CodigoTipoFreio'=>$_codigoTipoFreio,'Descricao'=>$_descricao,'CodigoRetorno'=>$_codigoRetorno),false);
    }
    /**
