<?php
/**
 * File for CodigosWebMotorsMotosWsdlClass to communicate with SOAP service
 ...
 */
/**
 * CodigosWebMotorsMotosWsdlClass to communicate with SOAP service
 * 
 * @package CodigosWebMotorsMotos
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20150429-01
 * @date 2017-11-03
 */
class CodigosWebMotorsMotosWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'http://integracao.webmotors.com.br/Motos/wsCodigosWebMotorsMotos.asmx?wsdl';
    /**
    ...
    /**
     * Constructor
     * @uses CodigosWebMotorsMotosWsdlClass::setLastError()
     * @uses CodigosWebMotorsMotosWsdlClass::initSoapClient()
     * @uses CodigosWebMotorsMotosWsdlClass::initInternArrayToIterate()
     * @uses CodigosWebMotorsMotosWsdlClass::_set()
     ...
     * @return CodigosWebMotorsMotosWsdlClass
     */
     ...
     * @return CodigosWebMotorsMotosWsdlClass|null
     */
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'CodigosWebMotorsMotosWsdlClass'))
            {
     ...
     * @uses CodigosWebMotorsMotosClassMap::classMap()
     * @uses CodigosWebMotorsMotosWsdlClass::getDefaultWsdlOptions()
     * @uses CodigosWebMotorsMotosWsdlClass::getSoapClientClassName()
     * @uses CodigosWebMotorsMotosWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('CodigosWebMotorsMotosClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = CodigosWebMotorsMotosClassMap::classMap();
     ...
     * If a class is named as {CodigosWebMotorsMotos}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('CodigosWebMotorsMotosSoapClient') && is_subclass_of('CodigosWebMotorsMotosSoapClient','SoapClient'))
            return 'CodigosWebMotorsMotosSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses CodigosWebMotorsMotosWsdlClass::WSDL_CACHE_WSDL
     * @uses CodigosWebMotorsMotosWsdlClass::WSDL_COMPRESSION
     * @uses CodigosWebMotorsMotosWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses CodigosWebMotorsMotosWsdlClass::WSDL_ENCODING
     * @uses CodigosWebMotorsMotosWsdlClass::WSDL_EXCEPTIONS
     * @uses CodigosWebMotorsMotosWsdlClass::WSDL_FEATURES
     * @uses CodigosWebMotorsMotosWsdlClass::WSDL_LOGIN
     * @uses CodigosWebMotorsMotosWsdlClass::WSDL_PASSWORD
     * @uses CodigosWebMotorsMotosWsdlClass::WSDL_SOAP_VERSION
     * @uses CodigosWebMotorsMotosWsdlClass::WSDL_STREAM_CONTEXT
     * @uses CodigosWebMotorsMotosWsdlClass::WSDL_TRACE
     * @uses CodigosWebMotorsMotosWsdlClass::WSDL_TYPEMAP
     * @uses CodigosWebMotorsMotosWsdlClass::WSDL_URL
     * @uses CodigosWebMotorsMotosWsdlClass::VALUE_WSDL_URL
     * @uses CodigosWebMotorsMotosWsdlClass::WSDL_USER_AGENT
     * @uses CodigosWebMotorsMotosWsdlClass::WSDL_PROXY_HOST
     * @uses CodigosWebMotorsMotosWsdlClass::WSDL_PROXY_PORT
     * @uses CodigosWebMotorsMotosWsdlClass::WSDL_PROXY_LOGIN
     * @uses CodigosWebMotorsMotosWsdlClass::WSDL_PROXY_PASSWORD
     * @uses CodigosWebMotorsMotosWsdlClass::WSDL_LOCAL_CERT
     * @uses CodigosWebMotorsMotosWsdlClass::WSDL_PASSPHRASE
     * @uses CodigosWebMotorsMotosWsdlClass::WSDL_AUTHENTICATION
     * @uses CodigosWebMotorsMotosWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses CodigosWebMotorsMotosWsdlClass::getSoapClient()
     * @uses CodigosWebMotorsMotosWsdlClass::getFormatedXml()
     ...
     * @uses CodigosWebMotorsMotosWsdlClass::getSoapClient()
     * @uses CodigosWebMotorsMotosWsdlClass::convertStringHeadersToArray()
     ...
     * @uses CodigosWebMotorsMotosWsdlClass::count()
     * @return int
     */
     ...
     * @uses CodigosWebMotorsMotosWsdlClass::getInternArrayToIterate()
     * @uses CodigosWebMotorsMotosWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses CodigosWebMotorsMotosWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses CodigosWebMotorsMotosWsdlClass::getInternArrayToIterateOffset()
     * @uses CodigosWebMotorsMotosWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses CodigosWebMotorsMotosWsdlClass::getInternArrayToIterateOffset()
     * @uses CodigosWebMotorsMotosWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see CodigosWebMotorsMotosWsdlClass::offsetGet()
     * @uses CodigosWebMotorsMotosWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses CodigosWebMotorsMotosWsdlClass::getAttributeName()
     * @uses CodigosWebMotorsMotosWsdlClass::__toString()
     * @uses CodigosWebMotorsMotosWsdlClass::_set()
     * @uses CodigosWebMotorsMotosWsdlClass::_get()
     * @uses CodigosWebMotorsMotosWsdlClass::setInternArrayToIterate()
     * @uses CodigosWebMotorsMotosWsdlClass::setInternArrayToIterateIsArray()
     * @uses CodigosWebMotorsMotosWsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses CodigosWebMotorsMotosWsdlClass::item()
     * @return mixed
     */
     ...
     * @uses CodigosWebMotorsMotosWsdlClass::item()
     * @uses CodigosWebMotorsMotosWsdlClass::length()
     * @return mixed
     */
