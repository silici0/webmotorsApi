<?php
/**
 * File for class CodigosWebMotorsMotosStructObterExtensoesVideos
 ...
 */
/**
 * This class stands for CodigosWebMotorsMotosStructObterExtensoesVideos originally named ObterExtensoesVideos
 ...
 * @date 2017-11-03
 */
class CodigosWebMotorsMotosStructObterExtensoesVideos extends CodigosWebMotorsMotosWsdlClass
{
    /**
    ...
    /**
     * Constructor method for ObterExtensoesVideos
     * @see parent::__construct()
     * @param string $_hashAutenticacao
     * @return CodigosWebMotorsMotosStructObterExtensoesVideos
     */
