<?php
/**
 * File for class CodigosWebMotorsMotosStructObterMarcaMotos
 ...
 */
/**
 * This class stands for CodigosWebMotorsMotosStructObterMarcaMotos originally named obterMarcaMotos
 ...
 * @date 2017-11-03
 */
class CodigosWebMotorsMotosStructObterMarcaMotos extends CodigosWebMotorsMotosWsdlClass
{
    /**
    ...
    /**
     * Constructor method for obterMarcaMotos
     * @see parent::__construct()
     * @param string $_hashAutenticacao
     * @return CodigosWebMotorsMotosStructObterMarcaMotos
     */
