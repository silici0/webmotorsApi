<?php
/**
 * File for class CodigosWebMotorsMotosStructObterTemplateAnimacaoMotos
 ...
 */
/**
 * This class stands for CodigosWebMotorsMotosStructObterTemplateAnimacaoMotos originally named ObterTemplateAnimacaoMotos
 ...
 * @date 2017-11-03
 */
class CodigosWebMotorsMotosStructObterTemplateAnimacaoMotos extends CodigosWebMotorsMotosWsdlClass
{
    /**
    ...
    /**
     * Constructor method for ObterTemplateAnimacaoMotos
     * @see parent::__construct()
     * @param string $_hashAutenticacao
     * @return CodigosWebMotorsMotosStructObterTemplateAnimacaoMotos
     */
