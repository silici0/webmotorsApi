<?php
/**
 * File for class CodigosWebMotorsMotosStructObterNumeroMarchasMoto
 ...
 */
/**
 * This class stands for CodigosWebMotorsMotosStructObterNumeroMarchasMoto originally named obterNumeroMarchasMoto
 ...
 * @date 2017-11-03
 */
class CodigosWebMotorsMotosStructObterNumeroMarchasMoto extends CodigosWebMotorsMotosWsdlClass
{
    /**
    ...
    /**
     * Constructor method for obterNumeroMarchasMoto
     * @see parent::__construct()
     * @param string $_hashAutenticacao
     * @return CodigosWebMotorsMotosStructObterNumeroMarchasMoto
     */
