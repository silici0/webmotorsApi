<?php
/**
 * File for class CodigosWebMotorsMotosStructObterTipoFreioMoto
 ...
 */
/**
 * This class stands for CodigosWebMotorsMotosStructObterTipoFreioMoto originally named obterTipoFreioMoto
 ...
 * @date 2017-11-03
 */
class CodigosWebMotorsMotosStructObterTipoFreioMoto extends CodigosWebMotorsMotosWsdlClass
{
    /**
    ...
    /**
     * Constructor method for obterTipoFreioMoto
     * @see parent::__construct()
     * @param string $_hashAutenticacao
     * @return CodigosWebMotorsMotosStructObterTipoFreioMoto
     */
