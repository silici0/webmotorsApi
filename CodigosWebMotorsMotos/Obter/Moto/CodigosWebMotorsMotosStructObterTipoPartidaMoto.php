<?php
/**
 * File for class CodigosWebMotorsMotosStructObterTipoPartidaMoto
 ...
 */
/**
 * This class stands for CodigosWebMotorsMotosStructObterTipoPartidaMoto originally named obterTipoPartidaMoto
 ...
 * @date 2017-11-03
 */
class CodigosWebMotorsMotosStructObterTipoPartidaMoto extends CodigosWebMotorsMotosWsdlClass
{
    /**
    ...
    /**
     * Constructor method for obterTipoPartidaMoto
     * @see parent::__construct()
     * @param string $_hashAutenticacao
     * @return CodigosWebMotorsMotosStructObterTipoPartidaMoto
     */
