<?php
/**
 * File for class CodigosWebMotorsMotosStructObterTipoAlimentacaoMoto
 ...
 */
/**
 * This class stands for CodigosWebMotorsMotosStructObterTipoAlimentacaoMoto originally named obterTipoAlimentacaoMoto
 ...
 * @date 2017-11-03
 */
class CodigosWebMotorsMotosStructObterTipoAlimentacaoMoto extends CodigosWebMotorsMotosWsdlClass
{
    /**
    ...
    /**
     * Constructor method for obterTipoAlimentacaoMoto
     * @see parent::__construct()
     * @param string $_hashAutenticacao
     * @return CodigosWebMotorsMotosStructObterTipoAlimentacaoMoto
     */
