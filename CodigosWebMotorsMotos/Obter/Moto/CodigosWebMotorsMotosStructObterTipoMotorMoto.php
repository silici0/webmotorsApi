<?php
/**
 * File for class CodigosWebMotorsMotosStructObterTipoMotorMoto
 ...
 */
/**
 * This class stands for CodigosWebMotorsMotosStructObterTipoMotorMoto originally named obterTipoMotorMoto
 ...
 * @date 2017-11-03
 */
class CodigosWebMotorsMotosStructObterTipoMotorMoto extends CodigosWebMotorsMotosWsdlClass
{
    /**
    ...
    /**
     * Constructor method for obterTipoMotorMoto
     * @see parent::__construct()
     * @param string $_hashAutenticacao
     * @return CodigosWebMotorsMotosStructObterTipoMotorMoto
     */
