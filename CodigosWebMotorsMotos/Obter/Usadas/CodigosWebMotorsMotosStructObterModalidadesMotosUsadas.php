<?php
/**
 * File for class CodigosWebMotorsMotosStructObterModalidadesMotosUsadas
 ...
 */
/**
 * This class stands for CodigosWebMotorsMotosStructObterModalidadesMotosUsadas originally named obterModalidadesMotosUsadas
 ...
 * @date 2017-11-03
 */
class CodigosWebMotorsMotosStructObterModalidadesMotosUsadas extends CodigosWebMotorsMotosWsdlClass
{
    /**
    ...
    /**
     * Constructor method for obterModalidadesMotosUsadas
     * @see parent::__construct()
     * @param string $_hashAutenticacao
     * @return CodigosWebMotorsMotosStructObterModalidadesMotosUsadas
     */
