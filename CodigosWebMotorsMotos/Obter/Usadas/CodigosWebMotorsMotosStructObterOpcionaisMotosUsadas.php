<?php
/**
 * File for class CodigosWebMotorsMotosStructObterOpcionaisMotosUsadas
 ...
 */
/**
 * This class stands for CodigosWebMotorsMotosStructObterOpcionaisMotosUsadas originally named obterOpcionaisMotosUsadas
 ...
 * @date 2017-11-03
 */
class CodigosWebMotorsMotosStructObterOpcionaisMotosUsadas extends CodigosWebMotorsMotosWsdlClass
{
    /**
    ...
    /**
     * Constructor method for obterOpcionaisMotosUsadas
     * @see parent::__construct()
     * @param string $_hashAutenticacao
     * @return CodigosWebMotorsMotosStructObterOpcionaisMotosUsadas
     */
