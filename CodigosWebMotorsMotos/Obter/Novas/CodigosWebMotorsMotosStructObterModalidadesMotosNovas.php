<?php
/**
 * File for class CodigosWebMotorsMotosStructObterModalidadesMotosNovas
 ...
 */
/**
 * This class stands for CodigosWebMotorsMotosStructObterModalidadesMotosNovas originally named obterModalidadesMotosNovas
 ...
 * @date 2017-11-03
 */
class CodigosWebMotorsMotosStructObterModalidadesMotosNovas extends CodigosWebMotorsMotosWsdlClass
{
    /**
    ...
    /**
     * Constructor method for obterModalidadesMotosNovas
     * @see parent::__construct()
     * @param string $_hashAutenticacao
     * @return CodigosWebMotorsMotosStructObterModalidadesMotosNovas
     */
