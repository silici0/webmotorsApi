<?php
/**
 * File for class WebmotorsEstoqueStructExcluirVideo
 ...
 */
/**
 * This class stands for WebmotorsEstoqueStructExcluirVideo originally named excluirVideo
 ...
 * @date 2017-10-02
 */
class WebmotorsEstoqueStructExcluirVideo extends WebmotorsEstoqueWsdlClass
{
    /**
     * The CodigoAnuncio
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for excluirVideo
     * @see parent::__construct()
     * @param int $_codigoAnuncio
     * @param string $_hashAutenticacao
     * @return WebmotorsEstoqueStructExcluirVideo
     */
