<?php
/**
 * File for WebmotorsEstoqueWsdlClass to communicate with SOAP service
 ...
 */
/**
 * WebmotorsEstoqueWsdlClass to communicate with SOAP service
 * 
 * @package WebmotorsEstoque
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20150429-01
 * @date 2017-10-02
 */
class WebmotorsEstoqueWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'http://integracao.webmotors.com.br/Motos/wsEstoqueRevendedorMotos.asmx?wsdl';
    /**
    ...
    /**
     * Constructor
     * @uses WebmotorsEstoqueWsdlClass::setLastError()
     * @uses WebmotorsEstoqueWsdlClass::initSoapClient()
     * @uses WebmotorsEstoqueWsdlClass::initInternArrayToIterate()
     * @uses WebmotorsEstoqueWsdlClass::_set()
     ...
     * @return WebmotorsEstoqueWsdlClass
     */
     ...
     * @return WebmotorsEstoqueWsdlClass|null
     */
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'WebmotorsEstoqueWsdlClass'))
            {
     ...
     * @uses WebmotorsEstoqueClassMap::classMap()
     * @uses WebmotorsEstoqueWsdlClass::getDefaultWsdlOptions()
     * @uses WebmotorsEstoqueWsdlClass::getSoapClientClassName()
     * @uses WebmotorsEstoqueWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('WebmotorsEstoqueClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = WebmotorsEstoqueClassMap::classMap();
     ...
     * If a class is named as {WebmotorsEstoque}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('WebmotorsEstoqueSoapClient') && is_subclass_of('WebmotorsEstoqueSoapClient','SoapClient'))
            return 'WebmotorsEstoqueSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses WebmotorsEstoqueWsdlClass::WSDL_CACHE_WSDL
     * @uses WebmotorsEstoqueWsdlClass::WSDL_COMPRESSION
     * @uses WebmotorsEstoqueWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses WebmotorsEstoqueWsdlClass::WSDL_ENCODING
     * @uses WebmotorsEstoqueWsdlClass::WSDL_EXCEPTIONS
     * @uses WebmotorsEstoqueWsdlClass::WSDL_FEATURES
     * @uses WebmotorsEstoqueWsdlClass::WSDL_LOGIN
     * @uses WebmotorsEstoqueWsdlClass::WSDL_PASSWORD
     * @uses WebmotorsEstoqueWsdlClass::WSDL_SOAP_VERSION
     * @uses WebmotorsEstoqueWsdlClass::WSDL_STREAM_CONTEXT
     * @uses WebmotorsEstoqueWsdlClass::WSDL_TRACE
     * @uses WebmotorsEstoqueWsdlClass::WSDL_TYPEMAP
     * @uses WebmotorsEstoqueWsdlClass::WSDL_URL
     * @uses WebmotorsEstoqueWsdlClass::VALUE_WSDL_URL
     * @uses WebmotorsEstoqueWsdlClass::WSDL_USER_AGENT
     * @uses WebmotorsEstoqueWsdlClass::WSDL_PROXY_HOST
     * @uses WebmotorsEstoqueWsdlClass::WSDL_PROXY_PORT
     * @uses WebmotorsEstoqueWsdlClass::WSDL_PROXY_LOGIN
     * @uses WebmotorsEstoqueWsdlClass::WSDL_PROXY_PASSWORD
     * @uses WebmotorsEstoqueWsdlClass::WSDL_LOCAL_CERT
     * @uses WebmotorsEstoqueWsdlClass::WSDL_PASSPHRASE
     * @uses WebmotorsEstoqueWsdlClass::WSDL_AUTHENTICATION
     * @uses WebmotorsEstoqueWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses WebmotorsEstoqueWsdlClass::getSoapClient()
     * @uses WebmotorsEstoqueWsdlClass::getFormatedXml()
     ...
     * @uses WebmotorsEstoqueWsdlClass::getSoapClient()
     * @uses WebmotorsEstoqueWsdlClass::convertStringHeadersToArray()
     ...
     * @uses WebmotorsEstoqueWsdlClass::count()
     * @return int
     */
     ...
     * @uses WebmotorsEstoqueWsdlClass::getInternArrayToIterate()
     * @uses WebmotorsEstoqueWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses WebmotorsEstoqueWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses WebmotorsEstoqueWsdlClass::getInternArrayToIterateOffset()
     * @uses WebmotorsEstoqueWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses WebmotorsEstoqueWsdlClass::getInternArrayToIterateOffset()
     * @uses WebmotorsEstoqueWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see WebmotorsEstoqueWsdlClass::offsetGet()
     * @uses WebmotorsEstoqueWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses WebmotorsEstoqueWsdlClass::getAttributeName()
     * @uses WebmotorsEstoqueWsdlClass::__toString()
     * @uses WebmotorsEstoqueWsdlClass::_set()
     * @uses WebmotorsEstoqueWsdlClass::_get()
     * @uses WebmotorsEstoqueWsdlClass::setInternArrayToIterate()
     * @uses WebmotorsEstoqueWsdlClass::setInternArrayToIterateIsArray()
     * @uses WebmotorsEstoqueWsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses WebmotorsEstoqueWsdlClass::item()
     * @return mixed
     */
     ...
     * @uses WebmotorsEstoqueWsdlClass::item()
     * @uses WebmotorsEstoqueWsdlClass::length()
     * @return mixed
     */
