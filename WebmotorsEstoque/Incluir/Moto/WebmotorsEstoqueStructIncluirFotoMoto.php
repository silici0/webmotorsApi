<?php
/**
 * File for class WebmotorsEstoqueStructIncluirFotoMoto
 ...
 */
/**
 * This class stands for WebmotorsEstoqueStructIncluirFotoMoto originally named incluirFotoMoto
 ...
 * @date 2017-10-02
 */
class WebmotorsEstoqueStructIncluirFotoMoto extends WebmotorsEstoqueWsdlClass
{
    /**
     * The CodigoAnuncio
     * Meta informations extracted from the WSDL
    ...
    public $image;
    /**
     * Constructor method for incluirFotoMoto
     * @see parent::__construct()
     * @param int $_codigoAnuncio
     * @param string $_hashAutenticacao
     * @param base64Binary $_image
     * @return WebmotorsEstoqueStructIncluirFotoMoto
     */
    public function __construct($_codigoAnuncio,$_hashAutenticacao = NULL,$_image = NULL)
    {
        parent::__construct(array('CodigoAnuncio'=>$_codigoAnuncio,'hashAutenticacao'=>$_hashAutenticacao,'image'=>$_image),false);
    }
    /**
