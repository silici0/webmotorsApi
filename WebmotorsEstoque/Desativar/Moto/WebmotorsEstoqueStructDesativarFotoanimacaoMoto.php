<?php
/**
 * File for class WebmotorsEstoqueStructDesativarFotoanimacaoMoto
 ...
 */
/**
 * This class stands for WebmotorsEstoqueStructDesativarFotoanimacaoMoto originally named desativarFotoanimacaoMoto
 ...
 * @date 2017-10-02
 */
class WebmotorsEstoqueStructDesativarFotoanimacaoMoto extends WebmotorsEstoqueWsdlClass
{
    /**
     * The CodigoAnuncio
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for desativarFotoanimacaoMoto
     * @see parent::__construct()
     * @param int $_codigoAnuncio
     * @param string $_hashAutenticacao
     * @return WebmotorsEstoqueStructDesativarFotoanimacaoMoto
     */
