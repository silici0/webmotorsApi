<?php
/**
 * File for WebmotorsLoginWsdlClass to communicate with SOAP service
 ...
 */
/**
 * WebmotorsLoginWsdlClass to communicate with SOAP service
 * 
 * @package WebmotorsLogin
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20150429-01
...
class WebmotorsLoginWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'https://integracao.webmotors.com.br/wsLoginSistemaRevendedor.asmx?wsdl';
    /**
    ...
    /**
     * Constructor
     * @uses WebmotorsLoginWsdlClass::setLastError()
     * @uses WebmotorsLoginWsdlClass::initSoapClient()
     * @uses WebmotorsLoginWsdlClass::initInternArrayToIterate()
     * @uses WebmotorsLoginWsdlClass::_set()
     ...
     * @return WebmotorsLoginWsdlClass
     */
     ...
     * @return WebmotorsLoginWsdlClass|null
     */
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'WebmotorsLoginWsdlClass'))
            {
     ...
     * @uses WebmotorsLoginClassMap::classMap()
     * @uses WebmotorsLoginWsdlClass::getDefaultWsdlOptions()
     * @uses WebmotorsLoginWsdlClass::getSoapClientClassName()
     * @uses WebmotorsLoginWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('WebmotorsLoginClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = WebmotorsLoginClassMap::classMap();
     ...
     * If a class is named as {WebmotorsLogin}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('WebmotorsLoginSoapClient') && is_subclass_of('WebmotorsLoginSoapClient','SoapClient'))
            return 'WebmotorsLoginSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses WebmotorsLoginWsdlClass::WSDL_CACHE_WSDL
     * @uses WebmotorsLoginWsdlClass::WSDL_COMPRESSION
     * @uses WebmotorsLoginWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses WebmotorsLoginWsdlClass::WSDL_ENCODING
     * @uses WebmotorsLoginWsdlClass::WSDL_EXCEPTIONS
     * @uses WebmotorsLoginWsdlClass::WSDL_FEATURES
     * @uses WebmotorsLoginWsdlClass::WSDL_LOGIN
     * @uses WebmotorsLoginWsdlClass::WSDL_PASSWORD
     * @uses WebmotorsLoginWsdlClass::WSDL_SOAP_VERSION
     * @uses WebmotorsLoginWsdlClass::WSDL_STREAM_CONTEXT
     * @uses WebmotorsLoginWsdlClass::WSDL_TRACE
     * @uses WebmotorsLoginWsdlClass::WSDL_TYPEMAP
     * @uses WebmotorsLoginWsdlClass::WSDL_URL
     * @uses WebmotorsLoginWsdlClass::VALUE_WSDL_URL
     * @uses WebmotorsLoginWsdlClass::WSDL_USER_AGENT
     * @uses WebmotorsLoginWsdlClass::WSDL_PROXY_HOST
     * @uses WebmotorsLoginWsdlClass::WSDL_PROXY_PORT
     * @uses WebmotorsLoginWsdlClass::WSDL_PROXY_LOGIN
     * @uses WebmotorsLoginWsdlClass::WSDL_PROXY_PASSWORD
     * @uses WebmotorsLoginWsdlClass::WSDL_LOCAL_CERT
     * @uses WebmotorsLoginWsdlClass::WSDL_PASSPHRASE
     * @uses WebmotorsLoginWsdlClass::WSDL_AUTHENTICATION
     * @uses WebmotorsLoginWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses WebmotorsLoginWsdlClass::getSoapClient()
     * @uses WebmotorsLoginWsdlClass::getFormatedXml()
     ...
     * @uses WebmotorsLoginWsdlClass::getSoapClient()
     * @uses WebmotorsLoginWsdlClass::convertStringHeadersToArray()
     ...
     * @uses WebmotorsLoginWsdlClass::count()
     * @return int
     */
     ...
     * @uses WebmotorsLoginWsdlClass::getInternArrayToIterate()
     * @uses WebmotorsLoginWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses WebmotorsLoginWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses WebmotorsLoginWsdlClass::getInternArrayToIterateOffset()
     * @uses WebmotorsLoginWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses WebmotorsLoginWsdlClass::getInternArrayToIterateOffset()
     * @uses WebmotorsLoginWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see WebmotorsLoginWsdlClass::offsetGet()
     * @uses WebmotorsLoginWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses WebmotorsLoginWsdlClass::getAttributeName()
     * @uses WebmotorsLoginWsdlClass::__toString()
     * @uses WebmotorsLoginWsdlClass::_set()
     * @uses WebmotorsLoginWsdlClass::_get()
     * @uses WebmotorsLoginWsdlClass::setInternArrayToIterate()
     * @uses WebmotorsLoginWsdlClass::setInternArrayToIterateIsArray()
     * @uses WebmotorsLoginWsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses WebmotorsLoginWsdlClass::item()
     * @return mixed
     */
     ...
     * @uses WebmotorsLoginWsdlClass::item()
     * @uses WebmotorsLoginWsdlClass::length()
     * @return mixed
     */
